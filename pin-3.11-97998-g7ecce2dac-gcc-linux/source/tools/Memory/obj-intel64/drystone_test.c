...
#define LOOPS        20000        /* Use this for faster machines */
...
main()
{
	int iter_index = 0,num_loops = LOOPS;
	for(iter_index=0;iter_index<2;iter_index++)
	{
       Proc0(num_loops);
...
printf("Dhrystone time for %ld passes = %ld\n", (long) num_loops, benchtime/HZ);
printf("This machine benchmarks at %ld dhrystones/second\n",
       ((long) num_loops) * HZ / benchtime);
#endif
